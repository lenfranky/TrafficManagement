...
def main(config_num=11):
    car_path = '../config_%d/car.txt' % config_num
    road_path = '../config_%d/road.txt' % config_num
    cross_path = '../config_%d/cross.txt' % config_num
    answer_path = '../config_%d/answer.txt' % config_num
    # ************************************* M A I N *******************************************#
    # load .txt files
